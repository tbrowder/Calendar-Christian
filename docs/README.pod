...
color for any day in the Gregorian calendar. It will eventually
...
B<advent-blue>. It is currently popular in ECUSA to color Advent
...
Constructs a DateTime::Calendar::Liturgical::Christian object from an
object of any other DateTime class.
...
Alternative spelling of C<color>.
